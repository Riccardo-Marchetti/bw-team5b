...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // DistributoreAutomatico distributore1 = new DistributoreAutomatico("via
        // Milano",true);
        // DistributoreAutomatico distributore2 = new DistributoreAutomatico("via
        // Po",true);
        // DistributoreAutomatico distributore3 = new DistributoreAutomatico("via
        // Piave",true);
        // DistributoreAutomatico distributore4 = new DistributoreAutomatico("via
        // Roma",true);
        //
        ...
        do {
            ...
            switch (scelta) {
                ...
                case 3:
                    ...
                    System.out.println("3 - Controlla il tempo effettivo delle tratte percorse da un mezzo"); // da controllare se la query fa affidamento alla traccia
                    System.out.println("4 - Ritorna al menù precedente");
                    try {
                        int scelta2 = scanner.nextInt();
                        switch (scelta2) {
